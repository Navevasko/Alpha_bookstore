...
class TextStyles {
  static final buttonTitle = GoogleFonts.inter(
      fontSize: 18, fontWeight: FontWeight.w400, color: AppColors.primary);
  static final buttonTitleWhite = GoogleFonts.inter(
  ...
  static final boldText = GoogleFonts.inter(
      fontSize: 16, fontWeight: FontWeight.w800, color: AppColors.gray);
